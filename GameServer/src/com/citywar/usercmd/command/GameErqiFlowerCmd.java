 ...
 *
 */
@UserCmdAnnotation(code = UserCmdType.GAME_ERQICOLOR, desc = "游戏叫")
public class GameErqiFlowerCmd extends AbstractUserCmd
{
    @Override
    public int execute(GamePlayer player, Packet packet)
    {
        ...
        packet.setParam1(DiZhuCmdType.AFTERBET);
