 ...
 *
 */
@UserCmdAnnotation(code = UserCmdType.GAME_ERQIMASTER, desc = "游戏叫")
public class GameErqiMasterPokerCmd extends AbstractUserCmd
{
    @Override
    public int execute(GamePlayer player, Packet packet)
    {
        ...
        packet.setParam1(DiZhuCmdType.PERHAND);
