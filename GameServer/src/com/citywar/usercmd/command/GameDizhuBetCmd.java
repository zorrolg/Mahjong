 ...
 *
 */
@UserCmdAnnotation(code = UserCmdType.GAME_DIZHUBET, desc = "游戏叫")
public class GameDizhuBetCmd extends AbstractUserCmd
{
    @Override
    public int execute(GamePlayer player, Packet packet)
    {
        ...
        if (null == p || p.getPlayerState() != PlayerState.Beting) {
        	//添加逻辑如果不是正在游戏中的玩家不能开叫
        	return 0;
        }
        packet.setClientId(player.getUserId());
        packet.setParam1(DiZhuCmdType.BETING);
