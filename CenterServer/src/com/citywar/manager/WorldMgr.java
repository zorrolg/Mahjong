...
//package com.citywar.dice.manager;
//
...
//
//    private static HashMap<Integer, CityInfo> allCitys = new HashMap<Integer, CityInfo>();
//    /**
//     * 正在World中的玩家数量
//     */
...
//
//    public static boolean addPlayer(int playerID, CityInfo player)
//    {
//    	boolean isAdd = false;
//        lock.writeLock().lock();
//        try
//        {
//	        if (!allCitys.containsKey(playerID))
//	        {
//	        	allCitys.put(playerID, player);
//	            addWorldPlayerCount();
//	            isAdd= true;
//	        }
//        } catch (Exception e) {
